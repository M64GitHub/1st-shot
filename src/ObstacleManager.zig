...
pub const ObstacleManager = struct {
    ...
    fn initSprites(self: *ObstacleManager, allocator: std.mem.Allocator) !void {
        const small_path = "assets/asteroid_small.png";
        const big_path = "assets/asteroid_big.png";
        const big2_path = "assets/asteroid_big2.png";
        const huge_path = "assets/asteroid_huge.png";
    ...
    pub fn trySpawn(
        ...
        const min_speed: usize = switch (kind) {
            .AsteroidSmall => 20 + 8 + 10,
            .AsteroidBig => 20 + 5 + 10,
            .AsteroidBig2 => 20 + 8 + 10,
            .AsteroidHuge => 15 + 5 + 10,
        };
        const max_speed: usize = switch (kind) {
            .AsteroidSmall => 30 + 15 + 10,
            .AsteroidBig => 25 + 15 + 10,
            .AsteroidBig2 => 25 + 15 + 10,
            .AsteroidHuge => 25 + 8 + 10,
        };
